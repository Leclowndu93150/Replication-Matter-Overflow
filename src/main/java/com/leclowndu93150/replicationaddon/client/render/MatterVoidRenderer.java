package com.leclowndu93150.replicationaddon.client.render;
...
public class MatterVoidRenderer<T extends MatterVoidBlockEntity> implements BlockEntityRenderer<T> {

    public MatterVoidRenderer(BlockEntityRendererProvider.Context p_173689_) {
    }
